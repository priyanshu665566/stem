        ...
        >
            ...
            <Motion.div
                ...
                style={{
                    ...
                    // Default tilt to show off the 3D depth and the orbit
                    transform: 'rotateX(-12deg) rotateY(18deg)',
                    display: 'flex',
                    justifyContent: 'center',
                    alignItems: 'center',
                    '--ring-size': 'min(260px, 70vw)', // CSS variable for responsive ring
                }}
            >
                {/* STEMCITY 3D Text */}
                <div style={{
                    ...
                    <div style={{
                        ...
                        textShadow: text3DShadow,
                        transform: 'translateZ(15px)',
                        marginLeft: '1.3em', // Aligns under the 'T'
                        transformStyle: 'preserve-3d'
                    }}>
                        CITY
                    </div>
                ...
                <div style={{
                    ...
                    height: '100%',
                    transformStyle: 'preserve-3d',
                    transform: 'rotateZ(-10deg) rotateX(15deg)', // Slightly diagonal
                }}>
                    {/* The Full Ring Track */}
                    <div style={{
                        position: 'absolute',
