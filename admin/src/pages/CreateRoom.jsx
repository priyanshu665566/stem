...
export default function CreateRoom() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.thumbnail && !selectedThumbnail) {
            showToast(false, 'Please upload or select a thumbnail before creating a room.');
            return;
        }
        ...
        try {
            ...
            // Revert state
            setFormData({
                city: '', room_name: '', assistant: '', meeting_url: '',
            ...
            setShowLoader(false);
            showToast(true, 'Room created successfully!');
        } catch (err) {
            console.error(err);
            ...
            <div className="max-w-7xl mx-auto py-4 sm:py-6 px-4 lg:px-8">
                ...
                <div className="mb-8 sm:mb-10 animate-fade-up">
                    ...
                    <p className="text-sm sm:text-base" style={{ color: subColor }}>
                        Configure and launch a new room environment.
                    </p>
                </div>
                    ...
                    <div className="w-full lg:w-[70%] animate-fade-up">
                        <div className="rounded-2xl p-5 sm:p-7" style={cardStyle}>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                                ...
                                <div>
                                    <label className="block text-xs font-semibold tracking-wide uppercase mb-1.5" style={{ color: labelColor }}>Room Name</label>
                                    <input type="text" name="room_name" required value={formData.room_name} onChange={handleInputChange} style={inputStyle} placeholder="E.g., Conference Room A" />
                                </div>
