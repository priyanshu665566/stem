...
import { getRooms, getMyRooms, deleteRoom } from '../api/rooms';
import { useTheme } from '../context/ThemeContext';
import { useAuth } from '../context/AuthContext';
import SmartImage from '../components/SmartImage';
import { Trash2, Edit, CodeXml, AlertCircle, Component } from 'lucide-react';
...
export default function MyRooms() {
    ...
    const fetchRooms = async () => {
        try {
            setLoading(true);
            setError('');
            const res = isContentCreator ? await getMyRooms() : await getRooms();
            setRooms(res.data);
        } catch (err) {
    ...
    return (
        <div className="max-w-7xl mx-auto py-6 sm:py-8 animate-fade-up">
            ...
            <div className="mb-8 sm:mb-10">
                ...
                >
                    Manage all your created rooms in one place.
                </p>
            </div>
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="w-12 h-12 rounded-lg overflow-hidden border" style={{ borderColor: tableBorderColor }}>
                                                    {room.thumbnail ? (
                                                        <SmartImage
                                                            avif={room.thumbnail.avif}
                                                            webp={room.thumbnail.webp}
                                                            fallback={room.thumbnail.original}
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <ActionButton
                                                        ...
                                                        title="Room Mapper (Coming Soon)"
                                                    />
                                                    <ActionButton
                                                        icon={Component}
                                                        color={buttonStyle.components}
                                                        onClick={() => navigate('/room-components')}
